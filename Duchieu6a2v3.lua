...
spawn(function()
  while wait() do
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {
        Title="Auto Farm Vật Chats Kì Dị",
        Description="", 
        Default=false })
...
Tabs.Shop:AddButton({
    Title="Tử Cước",
    Description="2.500.000Beli 5000f",
    Callback=function()
...
Tabs.Shop:AddButton({
    Title="Điện Trảo",
    Description="5000f 3.000.000BeIi",
    Callback=function()
...
Tabs.Shop:AddButton({
    Title="Thần Diệt Quền",
    Description="500f 1Jack Beli",
    Callback=function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end
})
Tabs.Shop:AddButton({
    Title="Huyết Quỷ Nghệ Thuật",
    Description="Bằng Giá GodHuman",
    Callback=function()
